...
namespace LINQ_SQL {
    class Program {
        ...
        static void Main(string[] args) {
            ...
            var r7 = (from p in products select p).Last();
            Console.WriteLine("LAST: " + r7);

            Console.WriteLine();
            //var r8 = products.Where(p => p.Price > 3000.0);
            var r8 = (from p in products where p.Price > 3000.0 select p);
            Print("PRICE > 3000: ", r8);

            //var r9 = products.Where(p => p.Price > 3000.0).FirstOrDefault();
            var r9 = (from p in products where p.Price > 3000.0 select p).FirstOrDefault();
